    ...
    describe "Admin" do
      describe "mails", type: :feature do
        ...
        describe "mails list" do
          before do
            FactoryGirl.create(:mail, :full_name => "UniqueTitleOne")
            FactoryGirl.create(:mail, :full_name => "UniqueTitleTwo")
          end
        ...
        describe "create" do
          ...
          context "duplicate" do
            before { FactoryGirl.create(:mail, :full_name => "UniqueTitle") }
        ...
        describe "edit" do
          before { FactoryGirl.create(:mail, :full_name => "A full_name") }
        ...
        describe "destroy" do
          before { FactoryGirl.create(:mail, :full_name => "UniqueTitleOne") }
